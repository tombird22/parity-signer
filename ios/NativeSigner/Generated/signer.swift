...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_signer_9a7_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_signer_9a7_rustbuffer_free(self, $0) }
    }
}
...
public func qrparserGetPacketsTotal(data: String, cleaned: Bool) throws -> UInt32 {
    ...
    signer_9a7_qrparser_get_packets_total(
...
public func qrparserTryDecodeQrSequence(data: String, cleaned: Bool) throws -> String {
    ...
    signer_9a7_qrparser_try_decode_qr_sequence(
        FfiConverterString.lower(data), 
        FfiConverterBool.lower(cleaned), $0)
}
    )
...
public func substratePathCheck(seedName: String, path: String, network: String)  -> DerivationCheck {
    return try! FfiConverterTypeDerivationCheck.lift(
        try!
    
    rustCall() {
    
    signer_9a7_substrate_path_check(
...
public func historyInitHistoryWithCert(dbname: String) throws {
    ...
    signer_9a7_history_init_history_with_cert(
...
public func historyInitHistoryNoCert(dbname: String) throws {
    ...
    signer_9a7_history_init_history_no_cert(
        FfiConverterString.lower(dbname), $0)
}
}
...
public func historyDeviceWasOnline() throws {
    ...
    signer_9a7_history_device_was_online($0)
}
}
...
public func historyGetWarnings() throws -> Bool {
    ...
    signer_9a7_history_get_warnings($0)
}
    )
}
...
public func historyAcknowledgeWarnings() throws {
    ...
    signer_9a7_history_acknowledge_warnings($0)
}
}
...
public func historyEntrySystem(event: Event) throws {
    ...
    signer_9a7_history_entry_system(
...
public func historySeedNameWasShown(seedName: String) throws {
    ...
    signer_9a7_history_seed_name_was_shown(
